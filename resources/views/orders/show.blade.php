        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    @if(Auth::user()->role === 'vendor' && $order->shop->user_id === Auth::id())
                        <div class="ml-4">
                            <form method="POST" action="{{ route('orders.update-status', $order) }}" class="inline">
                                @csrf
                                @method('PATCH')
                                <select name="status" onchange="this.form.submit()" class="border border-gray-300 rounded-md px-3 py-1 text-sm">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center border-b border-gray-200 pb-4">
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600">{{ $item->quantity }} x RM{{ number_format($item->price, 2) }}</p>
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="flex items-center mt-2">
                                    ...
                                    <span class="ml-2 text-xs text-blue-700">({{ number_format($order->rider->rating, 1) }})</span>
                                </div>
                            </div>
                            <div class="mt-3">
                                <form method="POST" action="{{ route('orders.unassign-rider', $order) }}"
    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-medium text-gray-900">Pilih Rider</h3>
...
function loadAvailableRiders() {
    fetch(`{{ route('orders.available-riders', $order) }}`)
                ...
                const riderCard = `
                    <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                        <div class="flex justify-between items-start">
                            ...
                            <form method="POST" action="{{ route('orders.assign-rider', $order) }}" class="ml-4">
                                @csrf
                                @method('PATCH')
